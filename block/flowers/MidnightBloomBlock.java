...
public class MidnightBloomBlock
extends BushBlock {
    public static final MapCodec<MidnightBloomBlock> CODEC = MidnightBloomBlock.simpleCodec(MidnightBloomBlock::new);
    ...
    public MidnightBloomBlock(BlockBehaviour.Properties properties) {
        super(properties);
    }
