...
public class RadiantDaisyBlock
extends BushBlock {
    public static final MapCodec<RadiantDaisyBlock> CODEC = RadiantDaisyBlock.simpleCodec(RadiantDaisyBlock::new);
    ...
    public RadiantDaisyBlock(BlockBehaviour.Properties properties) {
        super(properties);
    }
